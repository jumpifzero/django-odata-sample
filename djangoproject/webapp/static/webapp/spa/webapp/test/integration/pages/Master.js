								...
								this.waitFor({
									...
									success : function (oList) {
										...
										if (!aItemsNotInTheList.length) {
											...
											sCurrentId = aEntityData[aEntityData.length - 1].EmployeeID;
										} else {
											sCurrentId = aItemsNotInTheList[0].EmployeeID;
										}
				...
				assertions : {
					...
					theListHeaderDisplaysZeroHits : function () {
						return this.waitFor({
							viewName : sViewName,
							id : "page",
							matchers : new PropertyStrictEquals({name : "title", value : "Employees (0)"}),
							success : function () {
								Opa5.assert.ok(true, "The list header displays 'Employees (0)'");
							},
					...
					theListShouldBeSortedAscendingOnUnitNumber : function () {
						return this.theListShouldBeSortedAscendingOnField("EmployeeID");
					},
					...
					theListShouldHaveAllEntries : function () {
						...
						// retrieve all Employees to be able to check for the total amount
						...
						return this.waitFor({
							...
							success : function (oList) {
								...
								this.waitFor({
									id : "page",
									viewName : sViewName,
									matchers : new PropertyStrictEquals({name : "title", value : "Employees (" + iExpectedLength + ")"}),
									success : function () {
