sap.ui.define([
		...
		opaTest("MasterList Filtering on EmployeeID less than 100", function(Given, When, Then) {

			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog("EmployeeID").
		...
		opaTest("MasterList Filtering on EmployeeID more than 100", function(Given, When, Then) {
			// Action
			When.onTheMasterPage.iOpenViewSettingsDialog().
				and.iSelectListItemInViewSettingsDialog(">100 ").
				and.iPressOKInViewSelectionDialog();
