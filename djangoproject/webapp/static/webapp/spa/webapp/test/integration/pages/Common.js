sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("jumpifzero/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("jumpifzero.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["jumpifzero/localService/mockserver"], function (mockserver) {
