sap.ui.define([
	...
	return BaseObject.extend("jumpifzero.model.GroupSortState", {
		 ...
		 * @alias jumpifzero.model.GroupSortState
		 */
		...
		/**
		 * Sorts by FirstName, or by EmployeeID
		 *
		...
		/**
		 * Groups by EmployeeID, or resets the grouping for the key "None"
		 *
		 * @param {string} sKey - the key of the field used for grouping
		 * @returns {sap.ui.model.Sorter[]} an array of sorters
		 */
		group: function (sKey) {
			...
			if (sKey === "EmployeeID") {
				...
				this._oViewModel.setProperty("/sortBy", "EmployeeID");

				aSorters.push(
					new Sorter("EmployeeID", false,
