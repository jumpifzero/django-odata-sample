sap.ui.define([
		...
		return BaseObject.extend("jumpifzero.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias jumpifzero.model.ListSelector
			 */
			 ...
			 * @return {jumpifzero.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
